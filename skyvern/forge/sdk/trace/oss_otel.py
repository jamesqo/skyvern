...
_SAFE_ATTRIBUTE_KEYS = frozenset(
    {
        ...
        "step_id",
        "task_id",
        "task_execution_policy.blocked",
        "task_execution_policy.closed_page_count",
        "task_execution_policy.reason",
        "application_review.blocking_dialog_count",
        "application_review.final_submit_count",
        "application_review.form_found",
        "application_review.invalid_control_count",
        "application_review.missing_required_count",
        "application_review.ready",
        "application_review.upload_verified",
        "workflow_id",
